...
class User extends Model{
    ...
    private function validate(){
        ...
        if(!$this->start_date) {
            ...
            $errors['start_date'] = 'Data de admissão no formato incorreto.';
        }

        if ($this->end_date && !DateTime::createFromFormat('Y-m-d', $this->end_date)) {
            $errors['end_date'] = 'Data de desligamento no formato incorreto.';
        ...
        if(!$this->confirm_password) {
            $errors['confirm_password'] = 'Confimação é um campo obrigatório.';
